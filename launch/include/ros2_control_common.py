    ...
    robot_description = ParameterValue(
        Command(
            [
                ...
                LaunchConfiguration('esc_direct1_center_pulse_width'),
                ' esc_direct1_negative_pulse_width_radius:=',
                LaunchConfiguration('esc_direct1_negative_pulse_width_radius'),
                ' esc_direct1_positive_pulse_width_radius:=',
                LaunchConfiguration('esc_direct1_positive_pulse_width_radius'),
                ' esc_direct2_center_pulse_width:=',
                LaunchConfiguration('esc_direct2_center_pulse_width'),
                ' esc_direct2_negative_pulse_width_radius:=',
                LaunchConfiguration('esc_direct2_negative_pulse_width_radius'),
                ' esc_direct2_positive_pulse_width_radius:=',
                LaunchConfiguration('esc_direct2_positive_pulse_width_radius'),
                ' esc_direct3_center_pulse_width:=',
                LaunchConfiguration('esc_direct3_center_pulse_width'),
                ' esc_direct3_negative_pulse_width_radius:=',
                LaunchConfiguration('esc_direct3_negative_pulse_width_radius'),
                ' esc_direct3_positive_pulse_width_radius:=',
                LaunchConfiguration('esc_direct3_positive_pulse_width_radius'),
                ' esc_direct4_center_pulse_width:=',
                LaunchConfiguration('esc_direct4_center_pulse_width'),
                ' esc_direct4_negative_pulse_width_radius:=',
                LaunchConfiguration('esc_direct4_negative_pulse_width_radius'),
                ' esc_direct4_positive_pulse_width_radius:=',
                LaunchConfiguration('esc_direct4_positive_pulse_width_radius'),
