...
flowchart LR
    ...
    THR thruster_to_gate@-- "thruster_controller_*/esc/(mode, duty_cycle)<br/>thruster_controller_*/servo/(mode, commanded_angle)<br/>thruster_controller_*/thruster/esc/(voltage, water_leaked)" --> GATE
