...
class I2c : public hardware_model::interface::I2c {
  public:
    MOCK_METHOD1(open, tl::expected<void, hardware_model::interface::I2c::Error>(
    ...
    MOCK_CONST_METHOD0(
        read_byte, tl::expected<std::byte, hardware_model::interface::I2c::Error>());
    MOCK_METHOD2(
        write_byte_data,
        tl::expected<void, hardware_model::interface::I2c::Error>(
