#ifndef SINSEI_UMIUSI_CONTROL_HARDWARE_ESC_DIRECT_HPP
#define SINSEI_UMIUSI_CONTROL_HARDWARE_ESC_DIRECT_HPP
...
class EscDirect : public hardware_interface::ActuatorInterface {
  private:
...
#endif  // SINSEI_UMIUSI_CONTROL_HARDWARE_ESC_DIRECT_HPP